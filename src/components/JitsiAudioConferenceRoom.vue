...
export default {
  ...
  created () {
    console.log("audio conference room component created!");
  }
}
/* global $, JitsiMeetJS */
...
//     },
//     serviceUrl: 'https://meet.jit.si/http-bind?room=' + "ROOM-ID-HERE",
//     clientNode: 'http://jitsi.org/jitsimeet',
// };
...
// don't overwhelm the console with too much information
